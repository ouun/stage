...
class MegaMenu extends ServiceProvider
{
    ...
    {
        add_action('wp_nav_menu_item_custom_fields', [$this, 'stageMegaMenuCustomFields'], 10, 2);
        add_action('wp_update_nav_menu_item', [$this, 'stageMegaMenuNavUpdate'], 10, 2);
        add_filter('wp_get_nav_menu_items', [$this, 'stageMegaMenuItems'], 10, 3);
    }
     ...
     * @params array $args
     */
    public function stageMegaMenuCustomFields($item_id, $item)
    {
        ...
        <input
            type="hidden" name="custom-menu-meta-nonce"
        ...
        <p class="field-mega_menu description description-wide">
            <label for="custom-menu-meta-for-<?php echo $item_id; ?>" class="widefat edit-menu-item-description">
                <input
                    type="checkbox"
                    name="stage_mega_menu_meta[<?php echo $item_id; ?>]"
                    id="custom-menu-meta-for-<?php echo $item_id; ?>"
                    value="<?php echo esc_attr($stage_mega_menu_meta); ?>"
                    <?php echo $checked; ?>
                >
     ...
     * @return int
     */
    public function stageMegaMenuNavUpdate($menu_id, $menu_item_db_id)
    {
        // Verify this came from our screen and with proper authorization.
        if (
            ! isset($_POST['_stage_mega_menu_meta_nonce_name']) ||
            ! wp_verify_nonce($_POST['_stage_mega_menu_meta_nonce_name'], 'stage_mega_menu_meta_nonce')
        ) {
            return $menu_id;
        }
     ...
     * @return array
     */
    public static function stageMegaMenuItems($items, $menu, $args)
    {
