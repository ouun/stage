...
add_action('wp_enqueue_scripts', function () {
    wp_enqueue_script('stage/vendor.js', asset('scripts/vendor.js')->uri(), ['jquery'], null, true);
    wp_enqueue_script('stage/app.js', asset('scripts/app.js')->uri(), ['stage/vendor.js', 'jquery'], null, true);
    ...
    foreach ($styles as $stylesheet) {
        if (asset($stylesheet)->exists()) {
            wp_enqueue_style('stage/' . basename($stylesheet, '.css'), asset($stylesheet)->uri(), false, null);
        }
    }
}, 100);
