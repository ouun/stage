<form role="search" method="get" class="search-form relative flex items-stretch overflow-hidden p-0 m-0 h-full max-h-12 w-full border border-inherit" action="{{ home_url('/') }}">
