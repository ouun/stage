...
<div class="js-accordion border-l border-r mb-4 bg-gray-100" data-accordion-prefix-classes="animated-accordion">
  <div class="js-accordion__panel">
    <h2 class="js-accordion__header">
      <?php esc_attr_e( 'Calculate shipping', 'woocommerce' ); ?>
    ...
    <div class="js-accordion__content">
      <form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
          ...
          <p><button type="submit" name="calc_shipping" value="1" class="button outline w-full"><?php esc_html_e( 'Update', 'woocommerce' ); ?></button></p>
